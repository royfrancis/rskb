...
![BCR locus and structure](assets/vdj.webp){group="vdj"}

![Antibody structure](assets/joshi-2014.webp){group="vdj"}

![TCR structure](assets/tcr.webp){group="vdj"}

![Genomic structure of BCR and TCR chains](assets/antigen-receptor-loci.webp){group="vdj"}

Image references: [1](https://bsse.ethz.ch/lsi/research/systems-immunology.html), [2](hhttps://doi.org/10.1128/microbiolspec.aid-0017-2014), [3](https://blog.crownbio.com/t-cell-profiling), [4](https://digitalworldbiology.com/blog/immunoprofiling-how-it-works)
...
CDR3 is the most variable loop of the receptor, generated by V(D)J recombination, random nucleotide additions, and deletions at the junctions. Because this process is random, CDR3 regions vary in both sequence and length. In a healthy, undisturbed repertoire, CDR3 lengths follow a roughly Gaussian (bell-curve) distribution for each V gene family — many different clones of slightly different sizes. When a specific immune response or pathological event drives expansion of particular clones, this distribution becomes distorted. Probing CDR3 diversity is referred to as "CDR3 spectratyping".
...
- [{{< fa toolbox >}} CellRanger (Shell)](https://support.10xgenomics.com/single-cell-vdj/software/pipelines/latest/using/vdj)
  ...
  - Description of output from `cellranger vdj` [{{< fa external-link >}}](https://www.10xgenomics.com/support/software/cell-ranger/latest/analysis/outputs/cr-5p-outputs-overview-vdj)
  - Description of cellranger output annotation files [{{< fa external-link >}}](https://www.10xgenomics.com/support/software/cell-ranger/latest/analysis/outputs/cr-5p-outputs-annotations-vdj)
  - What is a productive contig? [{{< fa external-link >}}](https://www.10xgenomics.com/support/software/cell-ranger/latest/resources/cr-5p-vdj-algorithm-annotations)
...
- [{{< fa toolbox >}} VDJ Insights (Python)](https://github.com/BPRC-Bioinfo/VDJ-Insightshttps://github.com/BPRC-Bioinfo/VDJ-Insights) VDJ annotation
...
- [{{< fa toolbox >}} scRepertoire (R)](https://github.com/ncborcherding/scRepertoire) 10X VDJ cellranger input, Single cell only
- [{{< fa toolbox >}} djvdj (R)](https://github.com/rnabioco/djvdj)  10X VDJ cellranger input
- [{{< fa toolbox >}} immunarch (R)](https://immunarch.com/) 10X, MIXCR input, bulk
- [{{< fa toolbox >}} scirpy (Python)](https://scirpy.scverse.org/en/latest/) Toolkit
- [{{< fa toolbox >}} Dandelion (Python)](https://sc-dandelion.readthedocs.io/en/latest/) Toolkit
...
- [{{< fa toolbox >}} VDJView (R)](https://bitbucket.org/kirbyvisp/vdjview/src/master/) Shiny app
...
- [AIRR community forum](https://b-t.cr/)
- [AIRR community youtube](https://www.youtube.com/c/AIRRCommunity)
- [AIRR community podcast](https://www.antibodysociety.org/the-airr-community/airr-c-podcast/)
- [Antibody society](https://www.antibodysociety.org/)
